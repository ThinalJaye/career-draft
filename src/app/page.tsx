...
export default function Home() {
  return (
    <main>
      ...
      <div className="top-brandbar container">
        <a className="brand brand-pill" href="#top" aria-label="Career Draft home">
          <LogoMark />
          <div>
        ...
        <a className="top-order" href={whatsappUrl} target="_blank" rel="noreferrer">
          Start your CV <span>↗</span>
        </a>
      </div>

      <nav className="floating-nav" aria-label="Primary navigation">
        <div className="nav-dock">
          <a className="nav-home" href="#top" aria-label="Back to top">
            <LogoMark />
          </a>
        ...
        <div className="container hero-grid">
          <div className="hero-copy hero-enter">
            <div className="hero-kicker">
              ...
              Career documents for modern job seekers
            </div>
            <h1>Build a CV that <span>gets you noticed.</span></h1>
            <p className="hero-lead">
              Professional, modern and ATS-friendly CVs shaped around your career story, target role, and industry — with a process that feels simple from first message to final file.
            </p>
            ...
            <div className="hero-proof">
              <div><strong>01</strong><span>Send your details</span></div>
              <div><strong>02</strong><span>We craft the CV</span></div>
              <div><strong>03</strong><span>Review & receive</span></div>
            </div>
          </div>

          <div className="hero-visual hero-enter hero-enter-delay" aria-label="Career Draft CV preview mockups">
            ...
            <div className="floating-note note-one"><span className="note-icon">✦</span><div><small>DESIGN</small><strong>Tailored by industry</strong></div></div>
            <div className="floating-note note-two"><span className="note-icon">✓</span><div><small>QUALITY</small><strong>Clean • Modern • Focused</strong></div></div>
            <div className="floating-note note-three"><span className="note-icon">↗</span><div><small>READY</small><strong>Built for applications</strong></div></div>
          </div>
        </div>
      ...
      <section className="section alt-section" data-reveal>
        <div className="container">
      ...
      <section className="section" id="samples" data-reveal>
        <div className="container">
          ...
          <div className="sample-grid reveal-stagger">
            {samples.map((sample) => (
      ...
      <section className="section transform-section" data-reveal>
      ...
      <section className="section activity-section" data-reveal>
      ...
      <section className="section review-section" id="free-review" data-reveal>
